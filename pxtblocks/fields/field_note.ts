...
export class FieldNote extends Blockly.FieldNumber implements FieldCustom {
    ...
    private prepareNotes() {
        if (!FieldNote.Notes) {
            FieldNote.Notes = {
                28: { name: lf("{id:note}C"), prefixedName: lf("Dó grave"), freq: 131 },
                29: { name: lf("C#"), prefixedName: lf("Dó# grave"), freq: 139 },
                30: { name: lf("{id:note}D"), prefixedName: lf("Ré grave"), freq: 147 },
                31: { name: lf("D#"), prefixedName: lf("Ré# grave"), freq: 156 },
                32: { name: lf("{id:note}E"), prefixedName: lf("Mi grave"), freq: 165 },
                33: { name: lf("{id:note}F"), prefixedName: lf("Fá grave"), freq: 175 },
                34: { name: lf("F#"), prefixedName: lf("Fá# grave"), freq: 185 },
                35: { name: lf("{id:note}G"), prefixedName: lf("Sol grave"), freq: 196 },
                36: { name: lf("G#"), prefixedName: lf("Sol# grave"), freq: 208 },
                37: { name: lf("{id:note}A"), prefixedName: lf("Lá grave"), freq: 220 },
                38: { name: lf("A#"), prefixedName: lf("Lá# grave"), freq: 233 },
                39: { name: lf("{id:note}B"), prefixedName: lf("Si grave"), freq: 247 },
    
                40: { name: lf("{id:note}C"), prefixedName: lf("Dó médio"), freq: 262 },
                41: { name: lf("C#"), prefixedName: lf("Dó# médio"), freq: 277 },
                42: { name: lf("{id:note}D"), prefixedName: lf("Ré médio"), freq: 294 },
                43: { name: lf("D#"), prefixedName: lf("Ré# médio"), freq: 311 },
                44: { name: lf("{id:note}E"), prefixedName: lf("Mi médio"), freq: 330 },
                45: { name: lf("{id:note}F"), prefixedName: lf("Fá médio"), freq: 349 },
                46: { name: lf("F#"), prefixedName: lf("Fá# médio"), freq: 370 },
                47: { name: lf("{id:note}G"), prefixedName: lf("Sol médio"), freq: 392 },
                48: { name: lf("G#"), prefixedName: lf("Sol# médio"), freq: 415 },
                49: { name: lf("{id:note}A"), prefixedName: lf("Lá médio"), freq: 440 },
                50: { name: lf("A#"), prefixedName: lf("Lá# médio"), freq: 466 },
                51: { name: lf("{id:note}B"), prefixedName: lf("Si médio"), freq: 494 },
    
                52: { name: lf("{id:note}C"), prefixedName: lf("Dó tenor"), altPrefixedName: lf("Dó agudo"), freq: 523 },
                53: { name: lf("C#"), prefixedName: lf("Dó# tenor"), altPrefixedName: lf("Dó# agudo"), freq: 554 },
                54: { name: lf("{id:note}D"), prefixedName: lf("Ré tenor"), altPrefixedName: lf("Ré agudo"), freq: 587 },
                55: { name: lf("D#"), prefixedName: lf("Ré# tenor"), altPrefixedName: lf("Ré# agudo"), freq: 622 },
                56: { name: lf("{id:note}E"), prefixedName: lf("Mi tenor"), altPrefixedName: lf("Mi agudo"), freq: 659 },
                57: { name: lf("{id:note}F"), prefixedName: lf("Fá tenor"), altPrefixedName: lf("Fá agudo"), freq: 698 },
                58: { name: lf("F#"), prefixedName: lf("Fá# tenor"), altPrefixedName: lf("Fá# agudo"), freq: 740 },
                59: { name: lf("{id:note}G"), prefixedName: lf("Sol tenor"), altPrefixedName: lf("Sol agudo"), freq: 784 },
                60: { name: lf("G#"), prefixedName: lf("Sol# tenor"), altPrefixedName: lf("Sol# agudo"), freq: 831 },
                61: { name: lf("{id:note}A"), prefixedName: lf("Lá tenor"), altPrefixedName: lf("Lá agudo"), freq: 880 },
                62: { name: lf("A#"), prefixedName: lf("Lá# tenor"), altPrefixedName: lf("Lá# agudo"), freq: 932 },
                63: { name: lf("{id:note}B"), prefixedName: lf("Si tenor"), altPrefixedName: lf("Si agudo"), freq: 988 },
    
                64: { name: lf("{id:note}C"), prefixedName: lf("Dó agudo"), freq: 1046 },
                65: { name: lf("C#"), prefixedName: lf("Dó# agudo"), freq: 1109 },
                66: { name: lf("{id:note}D"), prefixedName: lf("Ré agudo"), freq: 1175 },
                67: { name: lf("D#"), prefixedName: lf("Ré# agudo"), freq: 1245 },
                68: { name: lf("{id:note}E"), prefixedName: lf("Mi agudo"), freq: 1319 },
                69: { name: lf("{id:note}F"), prefixedName: lf("Fá agudo"), freq: 1397 },
                70: { name: lf("F#"), prefixedName: lf("Fá# agudo"), freq: 1478 },
                71: { name: lf("{id:note}G"), prefixedName: lf("Sol agudo"), freq: 1568 },
                72: { name: lf("G#"), prefixedName: lf("Sol# agudo"), freq: 1661 },
                73: { name: lf("{id:note}A"), prefixedName: lf("Lá agudo"), freq: 1760 },
                74: { name: lf("A#"), prefixedName: lf("Lá# agudo"), freq: 1865 },
                75: { name: lf("{id:note}B"), prefixedName: lf("Si agudo"), freq: 1976 }
            }
        }
    }    
}
